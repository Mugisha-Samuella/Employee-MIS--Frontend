...
const Sidebar = () => {
  return (
    <div className="text-sm">
      <aside className="flex flex-col w-62 h-screen px-3 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <a href="#">
          <img
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            ...
            >
              ...
              <span className="mx-4 font-medium">Leave</span>
            </a>
